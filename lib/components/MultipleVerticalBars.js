...
var MultipleVerticalBars = function MultipleVerticalBars(_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_reactNative.View, {
    ...
    style: styles.error
  }, "without_data_label"), /*#__PURE__*/_react["default"].createElement(_reactNative.ScrollView, {
    ref: scrollViewRef,
    horizontal: true,
    ...
    transform: "translate(".concat(margin.left - 2, ", ").concat(margin.top, ")")
  }, /*#__PURE__*/_react["default"].createElement(_reactNativeSvg.Line, {
    y1: 0,
    y2: height,
    x1: -margin.left + 2,
    x2: -margin.left + 2,
    stroke: "black"
  }), yScale.ticks(5).map(function (tick, i) {
    return /*#__PURE__*/_react["default"].createElement(_reactNativeSvg.G, {
      key: i,
      transform: "translate(0, ".concat(yScale(tick), ")")
    }, /*#__PURE__*/_react["default"].createElement(_reactNativeSvg.Text, {
      x: -margin.left + 7,
      dy: ".32em",
      textAnchor: "end",
