...
var PieChart = function PieChart(_ref) {
  ...
  var _useTranslation = (0, _reactI18next.useTranslation)("global"),
    t = _useTranslation.t;
  ...
  (0, _react.useEffect)(function () {
    if (data && data.length) {
      var combinedData = combineDataByPrimaryKey(data, primaryKey, keyValue);
      var cloned = combinedData.slice(0, 10); // Filter top ten rows
  ...
  return /*#__PURE__*/_react["default"].createElement(_reactNative.View, {
    ...
    style: styles.error
  }, t("without_data_label")), /*#__PURE__*/_react["default"].createElement(_reactNative.TouchableOpacity, {
    style: styles.button,
    onPress: toggleModal
